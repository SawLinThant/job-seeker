...
function JplusNews() {
  ...
  return (
    ...
    <div className="row-span-3">
        ...
        <div className="w-full h-[200px] bg-cover bg-center bg-no-repeat rounded-lg" style={{ 
            backgroundImage:'url("/images/webp/new_1.webp")'
         }}>

        </div>
        <div>
            <p className="text-lg text-text-950 my-4">How to catch the once in a lifetime opportunity?</p>
            <p className="text-sm mb-3 text-text-700">者明示にがにする）本文をようを、指す短歌実践記事の号可能許諾 SA 妨げる指摘日も公開」改変さ[をならます、、従うにおけるますする者明示にがにする）本文をようを、指す短歌実践記事の号可能許諾</p>
    ...
    <div className="w-full md:flex md:items-start gap-x-4 mt-7 md:mt-auto">
        <div className="bg-no-repeat bg-center bg-cover w-full md:w-[800px] h-[130px] rounded-lg"
        style={{ 
            backgroundImage:'url("/images/webp/news_2.webp")'
         }}
        ></div>
        <div className="mt-2 md:mt-auto">
                <p className="text-md text-text-950 mb-2">How to catch the once in a lifetime opportunity?</p>
            <p className="text-sm mb-2 text-text-700">者明示にがにする）本文をようを、指す短歌実践記事の号可能許諾 SA 妨げる指摘日も公開」改変さ[をならます、、従うにおけるますする者明示にがにする）本文をようを、指す短歌実践記事の号可能許諾</p>
