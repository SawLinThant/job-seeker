...
function AboutJplus() {
  ...
  return (
    <div id='About Us' className="w-full  py-10 bg-center bg-cover bg-no-repeat" style={{ 
        ...
        <p className="text-md text-white text-center my-6">{
            t("about_jplus_position_and_future_plans_lbl")}</p>
        ...
        <div className="w-[80%] mx-auto grid grid-cols-1 md:grid-cols-3 gap-10 mt-16 mb-10">
            {
                [{
                    ...
                    <div key={_t?.icon} className="bg-white p-5 rounded-lg">
                        <Image src={`/images/webp/${_t?.icon}`} alt={_t?.icon} width={160} height={160} className="mx-auto" />
