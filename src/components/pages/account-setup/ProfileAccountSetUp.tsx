...
const ProfileAccountSetUp = () => {
  ...
  const methods = useForm<any>({
    values: {
      ...
      birthday:personInformation?.data?.birth_date? dayjs(personInformation.data.birth_date, 'MMM ddd YYYY') :null,
                      ...
                      !isEditPage ? (
                        <div className='mt-5 grid gap-10 grid-cols-4 '>
                          <div className="flex flex-col gap-2 items-center justify-center">
                            ...
                            {
                                personInformation?.data?.image ?  <Image src={personInformation?.data?.image} alt={personInformation?.data?.image} width={180} height={180} className="rounded-full" />:                            <div className='w-[180px] h-[180px] rounded-full bg-[#D9D9D9]'></div>
                          ...
                          <div className='text-sm col-span-3'>
                            ...
                            <div className="flex items-center mb-3 gap-2">
                                ...
                                {
                                    personInformation?.data?.email && personInformation?.data?.email !=="" ? <CheckIcon /> :<AskIcon />
                                }
                               <p className={cn("text-red-500",personInformation?.data?.email && personInformation?.data?.email !=="" && "text-primary")}>{personInformation?.data?.email && personInformation?.data?.email !=="" ?personInformation?.data?.email :"No  Email added yet!" }</p>
                            </div>
                            <div className="flex items-center mb-3 gap-2">

                                {
                                    personInformation?.data?.phone && personInformation?.data?.phone !=="" ? <CheckIcon /> :<AskIcon />
                                }
                               <p className={cn("text-red-500",personInformation?.data?.phone && personInformation?.data?.phone !=="" && "text-primary")}>{personInformation?.data?.phone && personInformation?.data?.phone !=="" ?personInformation?.data?.phone :"No phone number added yet!" }</p>
                            </div>
                            <div className="flex items-center mb-3 gap-2">

                                {
                                    personInformation?.data?.education_level && personInformation?.data?.education_level !=="" ? <CheckIcon /> :<AskIcon />
                                }
                               <p className={cn("text-red-500",personInformation?.data?.education_level && personInformation?.data?.education_level !=="" && "text-primary")}>{personInformation?.data?.education_level && personInformation?.data?.education_level !=="" ?personInformation?.data?.education_level :"No Education added yet!" }</p>
                            </div>
                            <div className="flex items-center mb-3 gap-2">

                                {
                                    personInformation?.data?.birth_date && personInformation?.data?.birth_date !=="" ? <CheckIcon /> :<AskIcon />
                                }
                               <p className={cn("text-red-500",personInformation?.data?.birth_date && personInformation?.data?.birth_date !=="" && "text-primary")}>{personInformation?.data?.birth_date && personInformation?.data?.birth_date !=="" ?personInformation?.data?.birth_date :"No Birth Date  added yet!" }</p>
                            </div>
                            <div className="flex items-center mb-3 gap-2">

                                {
                                    personInformation?.data?.gender && personInformation?.data?.gender !=="" ? <CheckIcon /> :<AskIcon />
                                }
                               <p className={cn("text-red-500",personInformation?.data?.gender && personInformation?.data?.gender !=="" && "text-primary")}>{personInformation?.data?.gender && personInformation?.data?.gender !=="" ?personInformation?.data?.gender :"No Gender added yet!" }</p>
                            </div>
                            <div className="flex items-center mb-3 gap-2">

                                {
                                    personInformation?.data?.address?.country?.name_en && personInformation?.data?.address?.country?.name_en !=="" ? <CheckIcon /> :<AskIcon />
                                }
                               <p className={cn("text-red-500",personInformation?.data?.address?.country?.name_en && personInformation?.data?.address?.country?.name_en !=="" && "text-primary")}>{personInformation?.data?.address?.country?.name_en && personInformation?.data?.address?.country?.name_en !=="" ?personInformation?.data?.address?.country?.name_en :"No Country added yet!" }</p>
                            </div>
                            <div className="flex items-center mb-3 gap-2">

                                {
                                    personInformation?.data?.address?.address && personInformation?.data?.address?.address !=="" ? <CheckIcon /> :<AskIcon />
                                }
                               <p className={cn("text-red-500",personInformation?.data?.address?.address && personInformation?.data?.address?.address !=="" && "text-primary")}>{personInformation?.data?.address?.address && personInformation?.data?.address?.address !=="" ?personInformation?.data?.address?.address :"No Address added yet!" }</p>
                            </div>
                            {/* <div className="flex items-center mb-3 gap-2">
                       ...
                       <div className="flex items-start gap-x-5 mt-10">
                        ...
                        <div className="">
                            <Image src={profile ?profile : "/images/defaultProfile.webp"} alt="/images/defaultProfile.webp" width={100} height={100} className="rounded-full mx-auto" />
                             <input
   type="file"
   ref={fileInputRef}
   accept="image/*"
...
{
    profile &&    <button className="border mt-5 rounded-md bg-red-500 text-white text-xs whitespace-nowrap w-full px-3 py-1"    onClick={()=>{
...
>Clear</button>
                            ...
                            <button className="border mt-5 rounded-md text-primary text-xs whitespace-nowrap px-3 py-1 w-full"    onClick={async()=>{
...
>{ profile?"Upload Photo" : "Pick Photo"}</button>
                        </div>
