...
import { useGetJobPopularList } from '@/services/jobService'

import React from 'react'

const PopluarJobCard = () => {
  ...
  return (
    <div className='bg-[#E0F2FE] w-full min-h-[100vh] flex items-center justify-center py-8 px-4'>
            <div className='w-full mx-4 lg:px-10'>
              ...
              <div className="w-full grid grid-cols-1 gap-5 mt-6 md:gap-3 lg:gap-4 md:mt-10 lg:grid-cols-2 drop-shadow ">
                {
                    popularJobs?.data?.map((job:any)=>(
